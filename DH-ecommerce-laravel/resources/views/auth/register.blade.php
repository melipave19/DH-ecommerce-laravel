            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            <label for="rol" class="col-md-4 col-form-label text-md-right">{{ __('Mi rol') }}</label>
                        ...
                        <div class="form-group row">
                            <label for="usuario" class="col-md-4 col-form-label text-md-right">{{ __('Nombre usuario') }}</label>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6 custom-file">
                                <input id="fotoPerfil" type="file" class="form-group" name="fotoPerfil" required autocomplete="fotoPerfil">
                            </div>
                        </div>
