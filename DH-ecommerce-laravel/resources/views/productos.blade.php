  ...
  <div class="row">
    <div class="col-sm-4">
      <div class="panel panel-primary">
        ...
        <div class="panel-footer"><p>Dell, HP, Bangho</p><button type="submit" name="buy" class="btn btn-warning" onclick="location.href='ecommerce-detalleProducts.php#products1'">Buy!</button></div>
      </div>
    </div>
    <div class="col-sm-4">
      <div class="panel panel-danger">
        ...
        <div class="panel-footer"><p>Acer, Lenovo </p><button type="submit" name="buy" class="btn btn-warning" onclick="location.href='ecommerce-detalleProducts.php#products2'">Buy!</button></div>
      </div>
    </div>
    <div class="col-sm-4">
      <div class="panel panel-success">
        ...
        <div class="panel-footer"><p>Phillip, Sony, Genius, JBL</p><button type="submit" name="buy" class="btn btn-warning" onclick="location.href='ecommerce-detalleProducts.php#products3'">Buy!</button></div>
      </div>
    </div>
  </div>
</div>
  ...
  <div class="row">
    <div class="col-sm-4">
      <div class="panel panel-primary">
        ...
        <div class="panel-footer"><p>Samsung, Vaio</p><button type="submit" name="buy" class="btn btn-warning" onclick="location.href='ecommerce-detalleProducts.php#products4'">Buy!</button></div>
      </div>
    </div>
    <div class="col-sm-4">
      <div class="panel panel-danger">
        ...
        <div class="panel-footer"><p>Personaliza tu PC</p><button type="submit" name="buy" class="btn btn-warning" onclick="location.href='ecommerce-detalleProducts.php#products5'">Buy!</button></div>
      </div>
    </div>
    <div class="col-sm-4">
      <div class="panel panel-success">
        ...
        <div class="panel-footer"><p>10% 20% 30% OFF</p><button type="submit" name="buy" class="btn btn-warning" onclick="location.href='ecommerce-detalleProducts.php#products6'">Buy!</button></div>
      </div>
    </div>
  </div>
</div>
